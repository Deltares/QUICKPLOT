...
\begin{figure}
\center{\includegraphics[width=125mm]{matlab/selection_window_qp.png}}
...
\item a field Val when the data is scalar
...
\begin{figure}
\center{\includegraphics[width=100mm]{matlab/4-2.png}}
...
\begin{figure}
\center{\includegraphics{matlab/standard_vector_plot.png}}
