...
\item use create and use macros (\Sref{Sec:Macros}).
\end{itemize}
...
\begin{figure}[H]
\center{\includegraphics[width=50mm]{Ch05/open_preferences.png}}
...
\begin{figure}[H]
\center{\includegraphics[width=100mm]{Ch05/prefs_general.png}}
...
\begin{figure}[H]
\center{\includegraphics[width=100mm]{Ch05/prefs_datafields.png}}
...
\begin{figure}[H]
\center{\includegraphics[width=100mm]{Ch05/prefs_figure.png}}
...
\begin{figure}[H]
\center{\includegraphics[width=100mm]{Ch05/prefs_gridview.png}}
...
\begin{figure}[H]
\center{\includegraphics[width=100mm]{Ch05/prefs_filefilters.png}}
...
\begin{figure}[H]
\center{\includegraphics[width=100mm]{Ch05/prefs_netcdf.png}}
...
\begin{figure}[H]
\center{\includegraphics[width=100mm]{Ch05/prefs_export.png}}
...
\begin{figure}
\center{\includegraphics[width=100mm]{Ch05/water_level_patches_vectors.png}}
...
\begin{figure}[b]
\center{\includegraphics[width=\textwidth]{Ch05/diff_files.png}}
...
The option to use macro files (see \Sref{Sec:Macros}) to repeat some steps helps but is not always straightforward to use.
...
\begin{figure}
\center{\includegraphics[width=0.8\textwidth]{Ch05/diff_files_example.png}}
\caption{Diff Files dialog.}
...
\begin{figure}
\center{\includegraphics{Ch05/5-2a.png}
...
\begin{figure}
\center{\includegraphics{Ch05/5-3a.png}}
...
\begin{figure}
\center{\includegraphics[width=100mm]{Ch05/2_plots_vertical_portrait.png}}
...
\begin{figure}
\center{\includegraphics{Ch05/edit_border_select.png}}
\caption{Select Edit Border from the Edit menu to edit the border texts.}
\label{fig:5.9}
\end{figure}

\begin{figure}
\center{\includegraphics[width=100mm]{Ch05/edit_border_edit.png}}
...
\begin{figure}
\center{\includegraphics{Ch05/5-4.png}}
...
\begin{figure}
\center{\includegraphics{Ch05/5-7.png}}
...
\begin{figure}
\center{\includegraphics[width=70mm]{Ch05/5-8.png}
...
\begin{figure}
\center{\includegraphics{Ch05/5-9a.png}
...
\begin{figure}
\center{\includegraphics{Ch05/5-10.png}}
...
\begin{figure}
\center{\includegraphics{Ch05/5-11.png}}
...
\begin{figure}
\center{\includegraphics{Ch05/5-12.png}}
...
\begin{figure}
\center{\includegraphics{Ch05/5-15.png}}
...
\begin{figure}
\center{\includegraphics{Ch05/5-16.png}}
...
\begin{figure}
\center{\includegraphics{Ch05/5-17.png}}
\caption{Open the colour map editor by clicking on the colour map preview.}
\label{fig:5.24}
\end{figure}

\begin{figure}
\center{\includegraphics{Ch05/5-18.png}}
...
\begin{figure}
\center{\includegraphics{Ch05/5-19.png}}
...
\begin{figure}
\center{\includegraphics[width=100mm]{Ch05/grid_selection_grid_range.png}}
...
\begin{figure}
\center{\includegraphics[width=100mm]{Ch05/grid_selection_arbitrary_line}}
\caption{Grid View selection window while selecting an Arbitrary Line.}
\label{fig:5.28}
\end{figure}

\section{Creating and using macros} \label{Sec:Macros}
\QUICKPLOT\ has functionality to record all actions of the main program window and some secondary interfaces, such as the file options dialog, to a macro file.
...
\begin{figure}
\center{\includegraphics{Ch05/5-21a.png}
\includegraphics{Ch05/5-21b.png}}
\caption{Macro file icons in the main program interface.}
\label{fig:5.29}
\end{figure}
...
\item Record commands to a macro file (menu item: Record Macro File).
...
\item Play/re-run a macro file (menu item: Run Macro File).
\end{itemize}

When the recording of commands is started all commands will be written in ASCII format to a file (extension .qpmacro) specified by you until you stop the recording.
The commands stored in a macro file can be played back.
To execute the list of commands stored in a macro file, select the Run Macro File option and select the file.
The MATLAB script file is intended for use with the \DMATLAB\ interface, but can be re-run using the Run Macro File option as well.

In addition to writing the commands to a macro or MATLAB script file, it is possible to echo the commands to the \QUICKPLOT\ Message Window.

This manual does not explain the commands in the macro file.
Below you find an example of the macro file of the procedure to define the Froude variable in \Sref{Sec:DefVariables} from the opening of the file until the first plot.
...
\begin{figure}
\center{\includegraphics{Ch05/result_matlab_script.png}}
\caption{End result of the example macro file and MATLAB script.}
\label{fig:5.30}
\end{figure}

\begin{Remark}
\item Interactive commands (manipulation of plots) are not recorded.
\item As an alternative to a macro file, you can write a MATLAB script file.
