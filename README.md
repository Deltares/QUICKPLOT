...
It has been programmed in the [MATLAB](https://nl.mathworks.com/products/matlab.html) language and the source functions also as the Delft3D-MATLAB interface for working with Delft3D data from within the MATLAB environment.
